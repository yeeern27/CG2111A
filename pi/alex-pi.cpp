...
void handleColour(TPacket *packet)
{
	...
	printf("white=0, red=1, green=2, error=3\n");
...
int main()
{
	...
	{
		char ch;
		printf("Command (f=forward, b=reverse, l=turn left, r=turn right, s=stop, c=clear stats, g=get stats, z=get dist, a=get colour, m=play music, q=exit)\n");
		scanf("%c", &ch);
